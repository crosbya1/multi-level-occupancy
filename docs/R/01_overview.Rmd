...
* **big-grid-zenodo-data.Rdata**: Post-processed data used to fit the models in this analysis 

These data can be downloaded from the Zenodo repository at: 

To be consistent with the GitHub repository (), when following this tutorial in R, create a directory named "docs" within your R working directory to store the data in. 
